    ...
    <div className={styles.homepageWelcome}>
      <div className={styles.panel}>
        <div className={styles.content}>
          ...
          <p className="intro">Cal Poly Print & Copy is your print solutions center. Conveniently located in Building 35, we specialize in small and large format prints for presentations, events, and the classroom. With easy online ordering and flexible hours, Cal Poly Print & Copy is the premier solution for your printing needs.</p>
        </div>
      </div>
    </div>
  );

          ...
          <div className="wp-block-media-text has-media-on-the-right is-stacked-on-mobile white-image-right">
            ...
            <figure className="wp-block-media-text__media">
              <Image
                ...
                width={980}
                height={630}
                alt="Exterior of Cal Maritime Marketplace building with palm trees and clear blue sky, representing campus life improvements and student support services featured on Cal Poly Print &amp; Copy’s website."
                layout="responsive"
              />
            </figure>
          </div>
